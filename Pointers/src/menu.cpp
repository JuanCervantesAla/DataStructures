...
bool Menu::menuOption(const int& selectedOption){
    ...
    switch (selectedOption) {
        ...
        case 7:
            cout<<list.print();
            cout<<"\nPick a sort metohod\n1.BubbleSort(By title)\n2.SelectSort(By title)\n3.InsertSort(By Interpreter)\n4.ShellSort(By interpreter)\n";
            cin>>sortOption;
            menu.sortMenu(sortOption);
            cout<<"\n!!!!Sorted!!!!\n";
            system("pause");
            break;
...
void Menu::searchOption(const int search,const int& optionData){
    ...
    if(realPosition==-1){
        ...
        cout<<"\nSong is in position: "+to_string(realPosition)<<endl;
...
//Just invoke sortingMethod
 void Menu::sortMenu(const int& sortOption){
